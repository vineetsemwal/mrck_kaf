...
public class SMSConsumerDemo {
    private static final Logger Log= LoggerFactory.getLogger(SMSConsumerDemo.class);
    ...
    public static void sendSms(DeliveryMessage value){
        Log.info("sending SMS for delivery message="+value.getOrderID()+"-"+value.getStatus());
    }
}
